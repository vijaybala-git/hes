...
_EXTRA_POPUP_KEYS = {
    ...
    "chart_eu7": ("The heat pump's energy across the twelve months of the HVAC-swap year, split "
                  ...
                  "charts.html"),
    # ── Rates (R) ───────────────────────────────────────────────────────────────
    "chart_r1":  ("Your electricity price over the years under each projection method — WhyWatt "
                  "Conservative, Moderate, Stress and EIA Pacific — all starting from your "
                  "current rate. The method you use is drawn bold; a fixed-%/yr method, when in "
                  "use, is added in bold. A dashed line shows scenario B when you compare two.",
                  "rates.html"),
    "chart_r2":  ("Your natural-gas price over the years under each projection method — WhyWatt "
                  "Conservative, Moderate, Stress and EIA Pacific — all starting from your "
                  "current gas rate. The WhyWatt gas curves rise steeply (they follow the CEC's "
                  "gas-system cost forecast); EIA Pacific is the federal outlook.",
                  "rates.html"),
    ...
    "chart_r5":  ("A heatmap of how the effective electricity rate varies by hour of day and "
                  ...
                  "acc.html"),
    "chart_r6":  ("Your electricity cost each year split into energy bought in the plan's peak "
                  "window, energy bought off-peak, and the fixed charge — after solar and the "
                  "battery — with the solar export credit below the axis. Shown for time-of-use "
                  "plans (pick a projection method with your utility's plan).",
                  "rates.html"),
    "chart_eu9": ("Your solar system's production each month next to your home's electricity "
                  "use in the same month, for the year you pick (default: the last year, once "
                  "the journey is complete). Summer surplus goes to the battery or is exported; "
                  "the winter shortfall comes from the grid.",
                  "solar.html"),
    "chart_eu10": ("Where your home's electricity came from each year: solar used directly, "
                   "solar stored and used later from the battery, and the grid (including any "
                   "grid charging of the battery), with exported solar below the axis. Hover a "
                   "year for self-use %, battery losses and the battery's monthly mode.",
                   "solar.html"),
}
